  ...
  if (typeof text !== "string") {
    ...
    if (typeof term !== "string") {
      ...
      text =
        term.prettyPrint() +
        " ~  ~  ~ " +
        term.prettyPrintLabels(freeVariables);
      changeText("result", "");
    } else {
      text = term;
      error = true;
    ...
    if (typeof tokened !== "string") {
      ...
      if (typeof parsedFunctionBody !== "string") {
        ...
        var functionDefinition = [
          functionName,
          parsedFunctionBody,
          parsedFunctionBody.prettyPrintLabels(freeVariables),
        ];
        var exists = false;
...
function hideButton() {
  changeText(
    "bulk",
    '<button type = "button" id = "bulk-btn" onclick = "revealBulkButton();">Bulk define aliases</button><button type = "button" id = "clear-all-btn" onclick = "removeFunctionsButton();">Clear all</button>',
  );
}
